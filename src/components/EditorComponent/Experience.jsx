    ...
    return(
        <div className="bg-white rounded-2xl p-4 shadow-inner drop-shadow-xl">
            ...
            <div className='w-full flex flex-col py-2 px-4 rounded-xl bg-gray-200'>
                    ...
                    <input type="text" name="experienceName" placeholder='Enter establishment name' className='bg-gray-200 outline-none'/>
                </div>
                <div className='w-full flex flex-col py-2 px-4 rounded-xl bg-gray-200'>
                    <label htmlFor="experienceLocation" className='font-bold'>Location:</label>
                    <input type="text" name="experienceLocation" placeholder='Enter location here' className='bg-gray-200 outline-none'/>
                </div>
                <div className='w-full flex flex-col py-2 px-4 rounded-xl bg-gray-200'>
                    <label htmlFor="experienceDesc" className='font-bold'>Description:</label>
                    <input type="text" name="experienceDesc" placeholder='Write a short description' className='bg-gray-200 outline-none'/>
                </div>
                <div className='w-full flex flex-row justify-between'>
                    <div className='w-5/12 bg-gray-200 py-2 px-4 rounded-xl'>
                        ...
                        <input type="number" name="experienceYearStart" placeholder='Enter start year' className='bg-gray-200 outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none'/>
                    </div>
                    <div className='w-5/12 bg-gray-200 py-2 px-4 rounded-xl'>
                        <label htmlFor="yearEnd" className='font-bold'>Year Ended:</label>
                        <input type="number" name="experienceYearEnd" placeholder='Enter end year' className='bg-gray-200 outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none'/>
                    </div>
                </div>
